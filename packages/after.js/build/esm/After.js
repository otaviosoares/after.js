...
var Afterparty = /** @class */ (function (_super) {
    ...
    function Afterparty(props) {
        ...
        _this.NotfoundComponent = get404Component(props.routes);
        return _this;
    }
    ...
    Afterparty.prototype.render = function () {
        ...
        return renderRoutes(getAllRoutes(this.props.routes), __assign(__assign({}, initialData), { prefetch: this.prefetch }), { location: location });
    };
    return Afterparty;
}(React.Component));
