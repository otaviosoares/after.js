...
var Afterparty = /** @class */ (function (_super) {
    ...
    Afterparty.prototype.componentDidUpdate = function (_prevProps, prevState) {
        ...
        if (navigated) {
            ...
            var instantMode_1 = isInstantTransition(transitionBehavior);
            ...
            loadInitialProps(routes, location_1.pathname, __assign({ location: location_1,
                history: history_1,
    ...
    Afterparty.prototype.render = function () {
        ...
        var instantMode = isInstantTransition(transitionBehavior);
        ...
        var routes = getAllRoutes(this.props.routes);
        initialData &&
        ...
        return renderRoutes(getAllRoutes(this.props.routes), __assign(__assign({}, initialData), { isLoading: isLoading, prefetch: this.prefetch }), { location: location });
    };
