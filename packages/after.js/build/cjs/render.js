...
var getAssets_1 = require("./getAssets");
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    ...
                    _d = getAssets_1.getAssets({ route: route, chunks: chunks }), scripts = _d.scripts, styles = _d.styles;
                    afterData = {
                    ...
                    return [4 /*yield*/, Doc.getInitialProps(__assign({ req: req,
                            ...
                            data: data, helmet: react_helmet_1.Helmet.renderStatic(), match: match,
                            scripts: scripts,
                ...
                case 2:
                    ...
                    doc = ReactDOMServer.renderToStaticMarkup(React.createElement(Document_1.__AfterContext.Provider, { value: props },
